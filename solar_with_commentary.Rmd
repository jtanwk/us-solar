...
```{r gen-by-source, warning=FALSE, fig.align = 'center', fig.width = 8, fig.height = 6}
gen %>%
...
```{r gen-by-state, message=F, warning=F, fig.align = 'center', fig.width = 8, fig.height = 8}
gen %>%
  filter(Year == 2016) %>%
...
```{r ghi-vs-gen, warning = F, message = F, fig.align = 'center', fig.width = 8, fig.height = 6}
gen %>%
  filter(Year == 2016) %>%
  filter(source == "Residential") %>%
  group_by(StateCode) %>%
...
```{r panels-by-pop-state, fig.align = 'center', fig.width = 8, fig.height = 6}
panels_by_pop %>%
...
```{r policy-by-state-year, warning=FALSE, message=FALSE, fig.align = 'center', fig.width = 8, fig.height = 10}
policy %>%
...
```{r panels-vs-policy, warning=FALSE, message=FALSE, fig.align = 'center', fig.width = 10, fig.height = 8}
